// src/pages/categories/MensSalon.jsx
...
export default function MensSalon() {
  const [services] = useState([
    {
      ...
      price: 299,
      duration: 45,
      bullets: ["Haircut & styling", "Beard trim"],
    ...
    },
    {
      ...
      price: 249,
      duration: 30,
      bullets: ["Relaxing massage", "Oil therapy"],
  ...
  return (
    <main style={styles.page}>
      <div style={styles.headerRow}>
        <div>
          <h1 style={styles.title}>Men's Salon & Massage</h1>
          <p style={styles.lead}>Grooming and massage services for men.</p>
        </div>
        <div>
      ...
      <div style={styles.columns}>
        <aside style={styles.left}>
          <div style={styles.cardBox}>
            <h4 style={styles.sidebarHeading}>Quick picks</h4>
            <div style={styles.iconGrid}>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>💈</div>
                <div style={styles.iconLabel}>Haircut</div>
              </div>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>🪒</div>
                <div style={styles.iconLabel}>Shave</div>
              </div>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>💆</div>
                <div style={styles.iconLabel}>Massage</div>
              </div>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>🧴</div>
                <div style={styles.iconLabel}>Beard care</div>
              </div>
            </div>
          </div>
        </aside>
        ...
        <section style={styles.main}>
          ...
          <div>
            <h2 style={styles.sectionTitle}>Other grooming services</h2>
