// src/pages/categories/WaterPurifier.jsx
  ...
  const [services] = useState([
    {
      ...
      price: 1999,
      duration: 120,
      bullets: ["Full installation", "Leak test"],
      image: "/images/services/ro-install.jpg",
    },
    {
      id: "wp2",
      ...
      price: 599,
      duration: 40,
      bullets: ["Replace cartridges", "Sanitize unit"],
  ...
  return (
    <main style={styles.page}>
      <div style={styles.headerRow}>
        <div>
          <h1 style={styles.title}>Native Water Purifier</h1>
          <p style={styles.lead}>
            Installations, maintenance and filter replacement for water
            purifiers.
          </p>
        </div>
        <div>
      ...
      <div style={styles.columns}>
        <aside style={styles.left}>
          <div style={styles.cardBox}>
            ...
            <div style={styles.iconGrid}>
              ...
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>🧾</div>
                <div style={styles.iconLabel}>Filter change</div>
              </div>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>🧼</div>
                <div style={styles.iconLabel}>Sanitization</div>
              </div>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>⚙️</div>
                <div style={styles.iconLabel}>Maintenance</div>
              </div>
            </div>
          </div>
        </aside>
        ...
        <section style={styles.main}>
          ...
          <div>
            <h2 style={styles.sectionTitle}>Maintenance & parts</h2>
