// src/pages/categories/WomensSalon.jsx
...
export default function WomensSalon() {
  const [services] = useState([
    ...
    },
    {
      ...
      price: 599,
      duration: 45,
      bullets: ["Deep cleanse", "Glow mask"],
  ...
  return (
    <main style={styles.page}>
      <div style={styles.headerRow}>
        <div>
          <h1 style={styles.title}>Women's Salon & Spa</h1>
          <p style={styles.lead}>
            Hair, beauty and spa treatments at your home.
          </p>
        </div>
        <div>
      ...
      <div style={styles.columns}>
        <aside style={styles.left}>
          <div style={styles.cardBox}>
            <h4 style={styles.sidebarHeading}>Treatments</h4>
            <div style={styles.iconGrid}>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>💇</div>
                <div style={styles.iconLabel}>Hair</div>
              </div>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>💅</div>
                <div style={styles.iconLabel}>Nails</div>
              </div>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>🌸</div>
                <div style={styles.iconLabel}>Facials</div>
              </div>
              <div style={styles.iconItem}>
                <div style={styles.iconThumb}>🧖</div>
                <div style={styles.iconLabel}>Spa</div>
              </div>
            </div>
          </div>
        </aside>
        ...
        <section style={styles.main}>
          ...
          <div>
            <h2 style={styles.sectionTitle}>Popular treatments</h2>
